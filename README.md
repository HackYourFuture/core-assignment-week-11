# Core program week 11 assignment
...
### Task 1
Implement your code in `Time.js`. Make sure to export the class and test it in `index.js`. Run the tests using `npm test` in the terminal.
